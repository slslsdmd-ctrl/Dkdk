...
def main_menu(uid):
    keyboard = [
        ...
        [
            InlineKeyboardButton("📈 Моя стата", callback_data="my_stats"),
        ...
        [
            InlineKeyboardButton("🔗 Кошелёк", callback_data="connect_wallet"),
        ...
        [
            ...
            InlineKeyboardButton("🌐 EN/RU", callback_data="change_lang")
        ]
    ]
...
def games_menu(uid):
    keyboard = [
        [
            ...
            InlineKeyboardButton("🔢 Число", callback_data="game_number")
        ],
        [
            InlineKeyboardButton("🎲 Сумма", callback_data="game_dice_sum"),
            InlineKeyboardButton("🎲 >7/<7", callback_data="game_dice_over")
        ],
        [
...
def demo_menu(uid):
    keyboard = [
        [
            ...
            InlineKeyboardButton("🔢 Число", callback_data="demo_number")
        ],
        [
            InlineKeyboardButton("🎲 Сумма", callback_data="demo_dice_sum"),
            InlineKeyboardButton("🎲 >7/<7", callback_data="demo_dice_over")
        ],
        [
